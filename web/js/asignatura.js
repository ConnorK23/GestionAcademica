...
$.asignatura.panel_alta = '#panel_pro_asig';
...
/**
 Esta función hace la llamada REST al servidor y crea la tabla con todos las asignaturas.
 */
$.asignatura.AsignaturaReadREST = function () {
    ...
    $.controller.doGet(
            ...
            function (json) {
                ...
                $($.asignatura.panel_list).append('<h3>Listado de Asignatura</h3>');
...
/**
 Crea un desplegable, un select, con todas las asignatura del servicio para seleccionar la asignatura a eliminar
 */
